...
set_ref_libs -remove results/02_ndm_${FLOW_TAG}/output/aes_128_multi-scenario-merge.ndm
set_ref_libs -add results/02_ndm_${FLOW_TAG}/output/aes_128_multi-scenario-merge.ndm
