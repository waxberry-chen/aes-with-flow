puts "--- Scenarios ---"
    ...
    current_corner $selected_corner
    ## read SDC
    ...
    set_clock_uncertainty 0.400 [get_clocks *]
    ...
    set_timing_derate -late  1.05 -cell_delay -net_delay -corners $selected_corner
    set_timing_derate -early 0.95 -cell_delay -net_delay -corners $selected_corner
    set_clock_uncertainty 0.400 [get_clocks *] -scenarios $selected_scenario
