...
# op5_lm_ndm.tcl
##########################
set user_define_name "multi-scenario-merge"
set flow_type aggregate ;# normal; physical_only; aggregate
set ref_physical_ndm "${ndm_dir}/aes_128_physical_only.ndm"
lappend ref_physical_ndm "${ndm_dir}/aes_128_multi-scenarios.ndm"
