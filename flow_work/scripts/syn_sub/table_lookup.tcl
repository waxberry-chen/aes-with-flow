# ==============================================================================
# file:    [table_lookup.tcl]
# author:  [cjy]
# created: [2025-06-13]
# lastest: [2025-06-13]
# version: [1.0.0]
# about:   [this file is to contold the initial constrain for subdeisgn table_lookup]
# ==============================================================================
# We already have:
...
current_design table_lookup
reset_design
set rpt_file "initial_table_lookup.rpt"
set design "table_lookup"
...
set_input_delay  2 $ALL_INP_EXC_CLK -clock $CLK_NAME
...
#dont touch the T subdesign , it has done
set_dont_touch t0 
set_dont_touch t1 
set_dont_touch t2 
set_dont_touch t3 
set_ungroup t0 false
set_ungroup t1 false
set_ungroup t2 false
set_ungroup t3 false
#defualt compile
