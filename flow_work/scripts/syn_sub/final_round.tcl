# ==============================================================================
# file:    [final_round.tcl]
# author:  [cjy]
# created: [2025-06-13]
# lastest: [2025-06-13]
# version: [1.0.0]
# about:   [this file is to contold the initial constrain for subdeisgn final_round]
# ==============================================================================
# We already have:
...
reset_design
set rpt_file "initial_final_round.rpt"
set design "final_round"
...
set_input_delay  [expr {$CLK_PERIOD * $OUTPUT_BUDGET}]  $ALL_INP_EXC_CLK -clock $CLK_NAME
...
set_dont_touch S4_1
set_ungroup S4_1 false
set_dont_touch S4_2
set_ungroup S4_2 false
set_dont_touch S4_3
set_ungroup S4_3 false
set_dont_touch S4_4
set_ungroup S4_4 false
